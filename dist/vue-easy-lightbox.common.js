...
// module
exports.push([module.i, ".icon[data-v-77174718]{width:1em;height:1em;vertical-align:-.15em;fill:currentColor;overflow:hidden}.fade-enter-active[data-v-77174718],.fade-leave-active[data-v-77174718]{-webkit-transition:all .3s ease;transition:all .3s ease}.fade-enter[data-v-77174718],.fade-leave-to[data-v-77174718]{opacity:0}.img-swiper[data-v-77174718]{position:relative;display:block}.modal[data-v-77174718]{z-index:9998;position:fixed;top:0;left:0;right:0;bottom:0;margin:0;background:rgba(0,0,0,.5)}.img-wrapper[data-v-77174718]{margin:0;position:absolute;top:50%;left:50%;-webkit-transform:translate(-50% -50%);transform:translate(-50% -50%);-webkit-box-shadow:#555 0 5px 20px 2px;box-shadow:0 5px 20px 2px #555;cursor:move}.img-wrapper.transition[data-v-77174718]{-webkit-transition:-webkit-transform .3s ease-in-out;transition:-webkit-transform .3s ease-in-out;transition:transform .3s ease-in-out;transition:transform .3s ease-in-out,-webkit-transform .3s ease-in-out}.img[data-v-77174718]{max-width:80vw;max-height:80vh;vertical-align:middle;position:relative}.btn__close[data-v-77174718],.btn__next[data-v-77174718],.btn__prev[data-v-77174718]{cursor:pointer;position:absolute;font-size:60px;color:#fff;opacity:.6;-webkit-transition:.15s linear;transition:.15s linear}.btn__close[data-v-77174718]:hover,.btn__next[data-v-77174718]:hover,.btn__prev[data-v-77174718]:hover{opacity:1}.btn__next.disable[data-v-77174718],.btn__next.disable[data-v-77174718]:hover,.btn__prev.disable[data-v-77174718],.btn__prev.disable[data-v-77174718]:hover{cursor:default;opacity:.2}.btn__next[data-v-77174718]{right:15%}.btn__next[data-v-77174718],.btn__prev[data-v-77174718]{top:50%;font-size:40px}.btn__prev[data-v-77174718]{left:15%}.btn__close[data-v-77174718]{top:10px;right:10px;font-size:40px}.pagination-total[data-v-77174718]{position:absolute;font-size:16px;top:16px;left:16px;color:#000}.toolbar-btns[data-v-77174718]{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;position:absolute;bottom:0;left:50%;-webkit-transform:translate(-50%);transform:translate(-50%);background:rgba(45,45,44,.8);border-radius:4px;border-bottom-right-radius:0;border-bottom-left-radius:0;padding:6px 24px 0}.toobar-btn[data-v-77174718]{cursor:pointer;display:inline-block;padding:6px}.toobar-btn .icon[data-v-77174718]{width:32px;height:32px;fill:#fff;color:#fff}.toobar-btn:hover .icon[data-v-77174718]{fill:#54b4ee;color:#54b4ee;cursor:pointer}.image-upload>input[data-v-77174718]{display:none}.vld-overlay[data-v-77174718]{bottom:0;left:0;position:absolute;right:0;top:0;-webkit-box-align:center;-ms-flex-align:center;align-items:center;display:none;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;overflow:hidden;z-index:1}.vld-overlay.is-active[data-v-77174718]{display:-webkit-box;display:-ms-flexbox;display:flex}.vld-overlay.is-full-page[data-v-77174718]{z-index:999;position:fixed}.vld-overlay .vld-background[data-v-77174718]{bottom:0;left:0;position:absolute;right:0;top:0;background:#fff;opacity:.5}.vld-overlay .vld-icon[data-v-77174718],.vld-parent[data-v-77174718]{position:relative}", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vue_easy_lightbox_vue_vue_type_style_index_0_id_77174718_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("9a57");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vue_easy_lightbox_vue_vue_type_style_index_0_id_77174718_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vue_easy_lightbox_vue_vue_type_style_index_0_id_77174718_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_vue_easy_lightbox_vue_vue_type_style_index_0_id_77174718_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("13b3");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("2211eb30", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"4ed21266-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/vue-easy-lightbox.vue?vue&type=template&id=77174718&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"fade"}},[(_vm.visible)?_c('div',{staticClass:"img-swiper modal",on:{"click":function($event){if($event.target !== $event.currentTarget){ return null; }return _vm.closeDialog($event)}}},[_c('loading',{attrs:{"active":_vm.loading,"loader":_vm.dots,"is-full-page":true},on:{"update:active":function($event){_vm.loading=$event}}}),_c('div',{staticClass:"img-wrapper",class:{transition: _vm.imgTransitionStatus},style:(_vm.imgStyle)},[_c('img',{staticClass:"img",attrs:{"src":_vm.visibleImgSrc,"alt":"","draggable":"false"},on:{"mousedown":function($event){_vm.handleMouseDown($event)},"mouseup":function($event){_vm.handleMouseUp($event)},"mousemove":function($event){_vm.handleMouseMove($event)}}})]),_c('div',{staticClass:"btns"},[(_vm.imgList.length !== 1)?_c('div',{staticClass:"btn__prev",class:{disable: _vm.imgIndex === 0},on:{"click":_vm.prev}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-prev"}})])]):_vm._e(),(_vm.imgList.length !== 1)?_c('div',{staticClass:"btn__next",class:{disable: _vm.imgIndex === _vm.imgList.length - 1},on:{"click":_vm.next}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-next"}})])]):_vm._e(),_c('div',{staticClass:"btn__close",on:{"click":_vm.closeDialog}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-close"}})])]),_c('div',{staticClass:"toolbar-btns"},[_c('div',{staticClass:"toobar-btn toolbar-btn__zoomin",on:{"click":function($event){_vm.zoomIn()}}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-zoomin"}})])]),_c('div',{staticClass:"toobar-btn toolbar-btn__zoomout",on:{"click":function($event){_vm.zoomOut()}}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-zoomout"}})])]),_c('div',{staticClass:"toobar-btn toolbar-btn__rotate",on:{"click":function($event){_vm.rotate()}}},[_c('svg',{staticClass:"icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":"#icon-rotate"}})])]),_c('div',{staticClass:"toobar-btn toolbar-btn__rotate image-upload",staticStyle:{"font-size":"30px !important"}},[_c('label',{staticClass:"icon",attrs:{"for":"file-input"}},[_c('div',{staticClass:"icon ti-folder"})]),_c('input',{staticClass:"input-file",attrs:{"id":"file-input","type":"file","multiple":"","name":_vm.uploadFieldName,"disabled":_vm.isSaving,"accept":"image/*"},on:{"change":function($event){_vm.filesChange($event.target.name, $event.target.files); _vm.fileCount = $event.target.files.length}}})]),_c('div',{staticClass:"toobar-btn toolbar-btn__rotate",staticStyle:{"font-size":"30px !important"}},[_c('div',{staticClass:"icon ti-trash",attrs:{"aria-hidden":"true"},on:{"click":function($event){_vm.remove()}}})])])]),(_vm.imgList.length !== 1)?_c('div',{staticClass:"pagination-total"},[_vm._v(_vm._s(_vm.imgIndex + 1)+"/"+_vm._s(_vm.imgTotal))]):_vm._e()],1):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/vue-easy-lightbox.vue?vue&type=template&id=77174718&scoped=true&
...
// EXTERNAL MODULE: E:/Nuthapol/Projects/alfred_client_vue/node_modules/axios/index.js
var axios = __webpack_require__("8206");
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);

// EXTERNAL MODULE: E:/Nuthapol/Projects/alfred_client_vue/node_modules/vue-loading-overlay/dist/vue-loading.min.js
var vue_loading_min = __webpack_require__("1c9f");
var vue_loading_min_default = /*#__PURE__*/__webpack_require__.n(vue_loading_min);

// EXTERNAL MODULE: E:/Nuthapol/Projects/alfred_client_vue/node_modules/sweetalert2/dist/sweetalert2.all.js
var sweetalert2_all = __webpack_require__("df06");
...
/* harmony default export */ var vue_easy_lightboxvue_type_script_lang_js_ = ({
  ...
  methods: (_methods = {
    upload: function upload(formData) {
      ...
      var BASE_URL = this.metaData.baseURL;
      var url = "".concat(BASE_URL, "/files/upload?token=") + token + '&type=photos&id=' + this.propData.property_ID;
      return axios_default.a.post(url, formData).then(function (response) {
      ...
      .then(function (x) {
        return x.map(function (img) {
          return assign_default()({}, img, {
            url: "".concat(BASE_URL, "/images/").concat(img.id)
          });
        });
    ...
    filesChange: function filesChange(fieldName, fileList) {
      ...
      from_default()(Array(fileList.length).keys()).map(function (x) {
    ...
    saveProperty: function saveProperty() {
      ...
      var self = this; // TODO: add the dynamic session info for the manager ID and the owner ID
      ...
      axios_default.a.get(url, {
        ...
        console.log('create/update property called: ' + stringify_default()(response.data));

        if (response.data) {
          if (response.request.status === 200) {// self.notifyVue('ti-home', 'bottom', 'right', notifyTitle, 2)
          }
        } else {
    ...
    notifyVue: function notifyVue(icon, verticalAlign, horizontalAlign, message, color) {
      this.$notify({
        component: {
    ...
    refresh: function refresh() {
      ...
      var url = baseURL + '/properties/getPropertyImageByPropID?token=' + token + '&ID=' + ID;
      axios_default.a.get(url, {
        dataType: 'json',
        headers: {
          'Accept': 'application/json',
    ...
    prev: function prev() {
      ...
      this.imgIndex -= 1;
      setTimeout(function () {
        _this3.imgTransitionStatus = !_this3.imgTransitionStatus;
      }, 0);
    }
    ...
    if (!this.images || this.images.length == 0) {
      ...
      console.log('after removed clicked i:', this.imgIndex); // upload data to the server

      this.currentStatus = STATUS_SAVING;
      var instance = this;
      this.delete(oldIndex).then(function (x) {
        _this4.currentStatus = STATUS_SUCCESS;
        console.log('wtf');
        instance.refresh();
      }).catch(function (err) {
        _this4.uploadError = err.response;
        _this4.currentStatus = STATUS_FAILED;
      });
      return;
    } // this.imgIndex

  }), _defineProperty(_methods, "delete", function _delete(oldIndex) {
    this.loading = true;
    var instance = this;
    var token = this.metaData.token;
    var BASE_URL = this.metaData.baseURL;
    var url = "".concat(BASE_URL, "/files/delete?token=") + token + '&fileUrl=' + this.rawImages[oldIndex].url + '&fileId=' + this.rawImages[oldIndex].id;
  ...
  computed: {
    ...
    imgList: function imgList() {
      if (is_array_default()(this.images)) {
        return this.images;
      } else {
        return [this.images];
      }
...
// EXTERNAL MODULE: ./src/vue-easy-lightbox.vue?vue&type=style&index=0&id=77174718&scoped=true&lang=scss&
var vue_easy_lightboxvue_type_style_index_0_id_77174718_scoped_true_lang_scss_ = __webpack_require__("90ae");
